...
INSERT INTO `customers` (`id`, `username`, `password`, `first_name`, `last_name`, `address`, `phone`, `policy_number`, `insurance_provider`, `account_confirmed`, `email`, `profile_content`, `avatar`) VALUES
